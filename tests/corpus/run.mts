...
//   node tests/corpus/run.mts zod rxjs          # just these packages
//   node tests/corpus/run.mts --check            # full corpus, do not replace matrix.md
//
...
const md = [
  '# Corpus results',
  '',
  '_Generated by `node tests/corpus/run.mts` — do not edit. See [README.md](README.md) for what each cell asserts._',
  '',
