...
echo "=== wrap with CHAINED map composed in Rust (oxc_sourcemap, no remapping) ==="
node --enable-source-maps --import ./sync-hooks-oxc-ts-rust.mjs runtime-throws.mjs 2>&1 | grep -E "Error|handler\." | head -2
