...
| version | builtin-eager-patch | cjs-append-hook | import-builtin-module-load | import-cjs-module-load-sync-hooks | import-cjs-module-load | import-cjs-synthetic-require | mixed-register-hooks | module-load-plain | module-load-sync-hooks | require-builtin-module-load-sync-hooks | require-module-load-override-hook | wrap-esm-lambda-tap-esm | wrap-esm-lambda-tap-cjs | tap-node-options-esm | tap-esm-main-esm-app | tap-esm-main-cjs-app | tap-cjs-main-esm-app | tap-cjs-main-cjs-app |
| ------- | ------------------- | --------------- | -------------------------- | --------------------------------- | ---------------------- | ---------------------------- | -------------------- | ----------------- | ---------------------- | -------------------------------------- | --------------------------------- | ----------------------- | ----------------------- | -------------------- | -------------------- | -------------------- | -------------------- | -------------------- |
| 22.15.0 | PATCHED_ALL         | APPENDED        | BYPASSED                   | BYPASSED                          | SEEN                   | BARE_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
| 22.16.0 | PATCHED_ALL         | APPENDED        | BYPASSED                   | BYPASSED                          | SEEN                   | BARE_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
| 22.18.0 | PATCHED_ALL         | APPENDED        | BYPASSED                   | BYPASSED                          | SEEN                   | BARE_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
| 22.22.2 | PATCHED_ALL         | APPENDED        | BYPASSED                   | BYPASSED                          | SEEN                   | BARE_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
| 22.22.3 | PATCHED_ALL         | APPENDED        | BYPASSED                   | SEEN                              | SEEN                   | BARE_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
| 22.23.1 | PATCHED_ALL         | APPENDED        | BYPASSED                   | SEEN                              | SEEN                   | BARE_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
| 24.10.0 | PATCHED_ALL         | APPENDED        | BYPASSED                   | BYPASSED                          | SEEN                   | BARE_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
| 24.11.0 | PATCHED_ALL         | APPENDED        | BYPASSED                   | BYPASSED                          | SEEN                   | BARE_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
| 24.11.1 | PATCHED_ALL         | APPENDED        | BYPASSED                   | SEEN                              | SEEN                   | BARE_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
| 24.18.0 | PATCHED_ALL         | APPENDED        | BYPASSED                   | SEEN                              | SEEN                   | FULL_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
| 26.5.0  | PATCHED_ALL         | APPENDED        | BYPASSED                   | SEEN                              | SEEN                   | FULL_REQUIRE                 | OK                   | SEEN              | SEEN                   | SEEN                                   | SEEN                              | OK                      | OK                      | OK                   | OK                   | OK                   | OK                   | OK                   |
...
- **The serverless delivery shape holds too.** On managed runtimes the node
  ...
  var, Azure Functions through the `languageWorkers__node__arguments` app
  setting, and both load the user's handler late — dynamic `import()` for
  ESM, `require()` for CJS. The two platforms enter through _different_
  loaders, though: Lambda's runtime interface client is an ES module
  (`"main": "dist/index.mjs"`; the managed runtime boots
  `/var/runtime/index.mjs`), while Azure's node worker is a CJS bundle. The
  `tap-node-options-esm` column registers the hook purely via `NODE_OPTIONS`;
  [`fixtures/bootstrap-sim.mjs`](fixtures/bootstrap-sim.mjs) and
  [`fixtures/bootstrap-sim.cjs`](fixtures/bootstrap-sim.cjs) then supply the
  ESM and CJS mains, each run against both handler module systems —
  `tap-esm-main-esm-app`, `tap-esm-main-cjs-app`, `tap-cjs-main-esm-app`,
  `tap-cjs-main-cjs-app`. OK on every rung — hook registration survives
  env-var delivery and platform-style late loading whichever loader started
  the process, on both sides of the fix train.
