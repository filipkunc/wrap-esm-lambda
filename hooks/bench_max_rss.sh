...
/usr/bin/time -v -o time_oxc_frida.txt node --require ./oxc-frida.cjs runtime.mjs
/usr/bin/time -v -o time_oxc_preload.txt sh -c "LD_PRELOAD=../wrap-esm-lambda.linux-x64-gnu.node node runtime.mjs"
