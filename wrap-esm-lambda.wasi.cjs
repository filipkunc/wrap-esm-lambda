...
let __wasmFilePath = __nodePath.join(__dirname, 'wrap-esm-lambda.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'wrap-esm-lambda.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  try {
    __wasmFilePath = __nodePath.resolve('wrap-esm-lambda-wasm32-wasi')
  } catch {
    throw new Error('Cannot find wrap-esm-lambda.wasm32-wasi.wasm file, and wrap-esm-lambda-wasm32-wasi package is not installed.')
  }
}
...
module.exports.exportsTapSnippet = __napiModule.exports.exportsTapSnippet
module.exports.exportsTapSnippetFromBuffer = __napiModule.exports.exportsTapSnippetFromBuffer
