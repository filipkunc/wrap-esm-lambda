 ...
 */
export function builtinGuardKey(entry) {
 ...
 */
function builtinSpellings(name) {
 ...
 */
export function builtinAliases(config) {
 ...
 *
 * @param {string} name the configured builtin name ('node:os', 'os', ...)
 * @param {import('./config.mjs').PatchEntry[]} entries entries targeting it
 * @returns {string}
 */
export function builtinWrapperSource(name, entries) {
  const target = requireBuiltin(name)
